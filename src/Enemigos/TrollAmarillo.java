...
public class TrollAmarillo extends Enemigo {
    ...
    public TrollAmarillo(Sprites spr, int px, int py, PowerUp p) {
        super();
        this.sprites = spr;
        ancho = 80;
        alto = 80;
        ...
        puntosAlMorir = 500;
        puntosAlCongelar = 300;
        alternar = false;
        contadorAnimacion = 0;
        velocidadRealX = moviendoDerecha ? ConfiguracionFisica.VELOCIDAD_TROLL_AMARILLO
                : -ConfiguracionFisica.VELOCIDAD_TROLL_AMARILLO;
    }
